...
const sendTwoFactorEnabledConfirmationEmail = async (email) => {
  const mailOptions = {
    from: process.env.EMAIL_USERNAME,
    to: email,
    ...
    html: `      <html>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="message">
              <p>Hello,</p>
              <p>Your account has been successfully enabled with Two Factor Authentication.</p>
...
module.exports = {
  ...
  sendTwoFactorEnabledConfirmationEmail,
};
